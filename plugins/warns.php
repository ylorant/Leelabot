...
class PluginWarns extends Plugin
{
	...
	public function SrvEventKill($killer, $killed, $type, $weapon = NULL)
	{
		...
		if(($killer->team == $killed->team OR !($killed->team == Server::TEAM_FREE AND $killed->team == Server::TEAM_FREE)) && !in_array($type, array('1', '3', '6', '7', '9', '10', '31', '32', '34')))
		{
	...
	public function SrvEventHit($player, $shooter, $partOfBody, $weapon)
	{
		...
		if($shooter->team == $player->team OR !($killed->team == Server::TEAM_FREE AND $killed->team == Server::TEAM_FREE))
		{
